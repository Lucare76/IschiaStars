...
function DataUnavailable({ error }: { error?: string }) {
  return (
    <div className="rounded-2xl bg-red-50 p-5 text-sm font-semibold text-red-800 shadow-soft ring-1 ring-red-200">
      ...
      <p className="mt-2">
        Connessione al database non riuscita. Per evitare numeri demo o dati non reali, le statistiche restano nascoste finche Supabase non risponde correttamente.
      </p>
