-- Migration 040: aggiunge email_link_clicked al vincolo CHECK degli event_type
-- in quote_events. Serve per registrare il primo click Brevo su un link email,
-- permettendo alla campanella e al follow-up di usare questo segnale commerciale.
